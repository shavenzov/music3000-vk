package com.audioengine.format
{
	/**
	...
	public final class FormatInfo
	{
		...
		public function FormatInfo( compressionType: Object, samplingRate: Number, numChannels: uint, bits: uint, numSamples: Number, dataOffset: Number = 0.0 )
		{
		...
		{
			return '[AudioFormatHeader compressionType: ' + _compressionType +
