    ...
    implements IFocusManagerComponent, IIMESupport
{
	...
	{
		if ( ! textDisplay.hitTestPoint( e.stageX, e.stageY ) )
		{
			stage.focus = null;
		}
	}
	...
	/*modified*/
	private function textDisplay_focusInHandler( e : Event ) : void
	{
    ...
    override protected function partAdded(partName:String, instance:Object):void
    {
        ...
        {
            /*modified*/
			textDisplay.addEventListener( TextOperationEvent.CHANGE, textDisplay_enterHandler );
    ...
    private function commitTextInput(dispatchChange:Boolean = false):void
    {
        ...
        else 
        {
			...
			{
				textDisplay.text = minimum.toString();
			}
			/*modified*/
