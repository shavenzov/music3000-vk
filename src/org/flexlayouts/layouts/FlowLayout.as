	...
	public class FlowLayout extends LayoutBase {
		...
		override public function measure():void
		{
			...
			for (var i:int = 0; i < count; i++) {
				...
				if (x + elementWidth + _padding > layoutTarget.width) {
			...
			layoutTarget.measuredWidth = layoutTarget.minWidth = maxWidth + _padding;
			layoutTarget.measuredHeight = layoutTarget.minHeight = maxHeight + _padding;
		}
